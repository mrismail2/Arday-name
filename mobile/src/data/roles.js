...
export const ROLES = {
  superadmin: {
    ...
    nav: ['dashboard', 'advisor', 'simulator', 'students', 'teachers', 'classes', 'attendance', 'finance', 'billing', 'exams', 'lessons', 'incidents', 'notice', 'reports', 'permissions', 'messages', 'settings'],
  },
  schooladmin: {
