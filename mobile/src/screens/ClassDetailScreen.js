  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: c.bg }]} edges={['top']}>
      ...
      <View style={[styles.hero, { backgroundColor: color }]}>
        ...
        <Text style={styles.hMeta}>{teacher} · {grade}{readOnly ? ' · daawasho keliya' : ''}</Text>
          ...
          renderItem={({ item }) => {
            ...
            return (
              <View style={[styles.feeRow, { backgroundColor: c.surface, borderColor: c.line }, shadow.sm]}>
                ...
                <Text style={[styles.attReason, { color: c.blue, marginTop: 10 }]}>Daawasho keliya — macalinka ayaa diiwaan geliya.</Text>
              </View>
            );
          }}
          showsVerticalScrollIndicator={false}
